...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> ประเภทคอมพิวเตอร์
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">เพิ่มประเภทคอมพิวเตอร์</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name">ประเภทคอมพิวเตอร์</label>
                    <input type="text" class="form-control" id="name" placeholder="ประเภทคอมพิวเตอร์" value=""></div>
            </div>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_computertype.js" charset="utf-8"></script>
