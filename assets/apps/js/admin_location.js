$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_location/fetch_admin_location',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_location/del_admin_location',
            params = {
                id: id
            }
        ...
        var url = '/admin_location/save_admin_location',
            params = {
                items: items
            }
        ...
        var url = '/admin_location/get_admin_location',
            params = {
                id: id
            }
...
function validate(items) {
  ...
  if (!items.name) {
        swal("กรุณาระบุสถานที่ตั้งอุปกรณ์");
        $("#name").focus();
    }
    else {
        return true;
