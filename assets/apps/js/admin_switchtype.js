$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_switchtype/fetch_admin_switchtype',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_switchtype/del_admin_switchtype',
            params = {
                id: id
            }
        ...
        var url = '/admin_switchtype/save_admin_switchtype',
            params = {
                items: items
            }
        ...
        var url = '/admin_switchtype/get_admin_switchtype',
            params = {
                id: id
            }
